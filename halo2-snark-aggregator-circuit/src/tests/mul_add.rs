            ...
            |region| {
                ...
                for _i in 0..round {
                    match self.test_case {
                        TestCase::Single => {
                            println!("single");
                            self.setup_single_proof_verify_test(
                        ...
                        TestCase::Aggregation => {
                            println!("Aggregation");
                            self.setup_aggregation_proof_verify_test(
                                config.base_field_config.clone(),
                                ctx,
                            )
                        }
...
mod tests {
    ...
    fn test_mul_add_single_proof_verify() {
        ...
        */
        ...
        let general_params: ParamsKZG<Bn256> = get_params_cached::<G1Affine, Bn256>(k as u32);
